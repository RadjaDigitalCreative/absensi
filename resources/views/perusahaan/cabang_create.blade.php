...
@section('content')
<?php $title ='Tambah Cabang Perusahaan'; ?>
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header">
						<strong>Tambah Cabang Perusahaan</strong> 
					</div>
					<div class="card-body card-block">
						<form action="{{route('cabang.perusahaan.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
							@csrf
							@method('POST')
							
							<div class="row form-group">
								<div class="col col-md-3"><label for="text-input" class=" form-control-label">Cabang Perusahaan</label></div>
								<div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_perusahaan" placeholder="Cabang Perusahaan" class="form-control"><small class="form-text text-muted">Silahkan Masukkan Cabang Perusahaan</small></div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3"><label for="email-input" class=" form-control-label">Lokasi Cabang</label></div>
								<div class="col-12 col-md-9"><input type="text" id="text-input" name="lokasi" placeholder="Lokasi Cabang"  class="form-control"><small class="help-block form-text">Silahkan Masukkan Lokasi Cabang</small></div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3"><label for="email-input" class=" form-control-label">Alamat Lengkap</label></div>
								<div class="col-12 col-md-9">
									<textarea type="text" name="alamat" placeholder="Alamat Lengkap Cabang Perusahaan"  class="form-control"></textarea>
